...
void start_mission2(all_t *all, mob_t *john)
{
...
void combat_mission2(all_t *all, mob_t *john)
{
...
void dialog_end_mission2(all_t *all, mob_t *john)
{
...
{
    if (!john || !john->pnj || !john->pnj->sprite || MISSION1 != finish ||
    MISSION3 != m_none)
        return;
